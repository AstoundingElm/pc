...
@foreign
func asctime(timeptr: tm_t *): char*;

@foreign
func ctime(timer: time_t *): char*;

@foreign
func gmtime(timer: time_t *): tm_t*;

@foreign
func localtime(timer: time_t *): tm_t*;

@foreign
func strftime(s: char*, maxsize: usize, format: char *, timeptr: tm_t *): usize;
*/