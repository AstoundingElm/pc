...
typedef struct AggregateItem {
    ...
    union {
        struct {
            ...
            Decl *internal_struct;
            bool is_union;
           // char *parent;

        bool is_internal_struct;
        };
...
typedef struct PP_Define PP_Define;

typedef struct PP_StmtList {
